            ...
            <div class="tab-content">
                ...
                <?php } ?>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step4">
                        ...
                        <div class="col-md-6 dynamic model">
                          <div class="form-group">
                                ...
                                <input type="text" name="model_other" id="model_other" placeholder="Model" class="form-control" style="display:inline-block;width:50%;display: none;" />
                        ...
                        <div class="col-md-6 dynamic register_num">
                          <div class="form-group">
                               <input type="text" name="registered_number" id="registered_number" placeholder="Registered Number *" class="form-control" required="required">
                                
                          </div>
                        </div>
                        <div class="col-md-6 dynamic bucket_capacity">
                          <div class="form-group">
                                <input type="text" name="bucket_capacity" id="bucket_capacity" placeholder="Bucket Capacity *" class="form-control" required="required" onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                               
                          </div>
                        </div>
                        <div class="col-md-6 dynamic life_tax_details">
                          <div class="form-group">
                              <select class="form-control select" name="life_tax_details[]" id="life_tax_details" multiple="multiple" required="required">
                        ...
                        <div class="col-md-6 manufacture_year">
                          <div class="form-group">
                              <select class="form-control" name="manufacture_year" id="manufacture_year" required="required">
                        ...
                        <div class="col-md-6 dynamic kelly_length">
                          <div class="form-group">
                                <input type="text" name="kelly_length" id="kelly_length" placeholder="Kelly Length" class="form-control" onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                
                          </div>
                        </div>
                        <div class="col-md-6 dynamic arm_length">
                          <div class="form-group">
                                <input type="text" name="arm_length" id="arm_length" placeholder="Arm Length" class="form-control" onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                              <select name="exact_location[]" class="form-control select" id="exact_location_id" multiple="multiple"  placeholder="Choose  Serving location(s)*" required="required">
                                <?php foreach($regions as $region)
...
$('#subcategory_id').change(function(){
    ...
    if($(this).val() == 5 || $(this).val() == 7 || $(this).val() == 10) 
        $("div#filedrag_loadchart").hide();
    else  
        $("div#filedrag_loadchart").show();
