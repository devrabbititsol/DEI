			...
			<div class="item active">
			  ...
			  <div class="carousel-caption">
			  	<h2>POST YOUR CLASSIFIEDS HERE</h2>
                                <h4><a href="mailto:info@digitalequipmentsindia.com" style="color:#ea2e2e;">Contact us</a> for placing your classifieds with us</h4>
			  </div>
			</div>
                        <div class="item">
			  <img src="images/banner-1.png" alt="ss">
...
<div class="container">
    ...
    if(Yii::$app->user->isGuest)
        echo '<a href="login" class="btn btn-default pull-right postyourad">Post Your Add</a>';
    else
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item <?php if($i==0) echo "active";?>">
        <a href="<?php echo $ad->ad_weblink;?>" target="_blank">
            <img src="<?php echo $ad_image; ?>" alt="..." style="height:400px;">
        </a>
    </div>
    <?php $i++; endforeach; ?>
  </div>
...
<section class="gap rotate40">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    ?>
      ...
      <div class="col-md-6">
                <?php 
                /*if(@$array_hire_services[$index]['image_url']!='' && file_exists(@$array_hire_services[$index]['image_url']))
                  {
                  $list_image=@$array_hire_services[$index]['image_url'];
                  }
                  else{ $list_image=Yii::$app->params['SITE_URL'] ."uploads/noimage.png";}*/
                ?>
		<div class="service_box">
				<img src="<?php echo $array_hire_services[$index]['image_url']; ?>" class="img-responsive" />
			...
			<div class="sevicebox_content">
			   <h4><?php echo @$array_hire_services[$index]['category_name'];?></h4>
				...
				<div class="col-sm-4"><p>Capacity</p><?php echo @$array_hire_services[$index]['capacity'];?></div>
				<div class="col-sm-4"><p>Year of Manufacturer</p><?php echo @$array_hire_services[$index]['manufacture_year'];?></div>
				<div class="clearfix"></div>
				<div class="hr"></div>
				<div class="footer">
					...
					<div class="col-md-8 col-sm-8">
						<a href="products?product_id=<?php echo @$array_hire_services[$index]['product_id']; ?>&product_type=<?php if(@$array_hire_services[$index]['product_type']==0) echo "hire"; else if(@$array_hire_services[$index]['product_type']==1) echo "sale"; else if(@$array_hire_services[$index]['product_type']==2) echo "both";?>" class="btn" ><?php if(@$array_hire_services[$index]['product_type']==0) echo "hire"; else if(@$array_hire_services[$index]['product_type']==1) echo "sale"; else if(@$array_hire_services[$index]['product_type']==2) echo "hire/sale";?></a>
                                        </div>
				</div>
				<div class="clearfix"></div>
			</div>
  	  ...
  	  <div class="col-md-6">
                <?php 
                /*if(@$array_sale_services[$index]['image_url']!='' && file_exists($array_sale_services[$index]['image_url']))
                  {
                  $list_image=@$array_sale_services[$index]['image_url'];
                  }
                  else{ $list_image=Yii::$app->params['SITE_URL'] ."uploads/noimage.png";}*/
                ?>
		<div class="service_box">
				<img src="<?php echo $array_sale_services[$index]['image_url']; ?>" class="img-responsive" />
			...
			<div class="sevicebox_content">
			   <h4><?php echo @$array_sale_services[$index]['category_name'];?></h4>
				...
				<div class="col-sm-4"><p>Capacity</p><?php echo @$array_sale_services[$index]['capacity'];?></div>
				<div class="col-sm-4"><p>Year of Manufacturer</p><?php echo @$array_sale_services[$index]['manufacture_year'];?></div>
				<div class="clearfix"></div>
				<div class="hr"></div>
				<div class="footer">
					<div class="col-md-4 col-sm-4">
					...
					<div class="col-md-8 col-sm-8">
						<a href="products?product_id=<?php echo @$array_sale_services[$index]['product_id']; ?>&product_type=<?php if(@$array_sale_services[$index]['product_type']==0) echo "hire"; else if(@$array_sale_services[$index]['product_type']==1) echo "sale"; else if(@$array_sale_services[$index]['product_type']==2) echo "both";?>" class="btn" ><?php if(@$array_sale_services[$index]['product_type']==0) echo "hire"; else if(@$array_sale_services[$index]['product_type']==1) echo "sale"; else if(@$array_sale_services[$index]['product_type']==2) echo "hire/sale";?></a>    
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
    ...
    <div class="col-md-12">
        ...
        foreach($locations as $location)
        {
            ...
            if($location['location_type']==1)
                $googleloc[] = array("location"=>array('address'=>"$address",'country' => "$country"),'htmlContent' => "<h4>$address</h4>");
        }
          ...
          <div class="modal-post">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" placeholder="Your Mobile No " name="phone" required value="<?php if(@$user->phone_number !='') echo @$user->phone_number;else echo '91';?>"  maxlength="13" onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" readonly>
