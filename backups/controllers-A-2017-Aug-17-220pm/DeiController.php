...
class DeiController extends Controller
{
    ...
    public function actionFeedback()
    {
        ...
        {
            try{
                $subject="New Feedback | Digital Equipments India";
        ...
        try{
            ...
            if (!isset($_POST['repeat'] )) 
            {
                ...
                if($_POST['package_type'] == 2) //1= free, 2=paid
                {
                    ...
                    /*$redirectUrl = Yii::$app->params['SITE_URL'].'productsuccess';
                    $cancelUrl = Yii::$app->params['SITE_URL'];
                    
                    $params = [
                        'tid' => time(),
                        'merchant_id' => Yii::$app->params['ccavenue_merchant_id'],
                        'order_id' => 14523,
                        'amount' => 2500,
                        'currency' => 'INR',
    ...
    public function actionMyAccount()
    {
        ...
        $userDetails = User::get_user_details_by_id();
        $hireDetails = User::hire_details_by_user();
        $supplyDetails = User::supply_details_by_user();
        $buyDetails = User::buy_details_by_user();
        $saleDetails = User::sale_details_by_user();
