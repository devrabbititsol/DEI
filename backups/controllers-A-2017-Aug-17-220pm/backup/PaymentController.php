...
//            ],
    ...
    public function actionSubscription()
    {
        ...
        if (isset($request['subscribe'])) {
            ...
            $redirectUrl = Url::to(['payment/payment-process'], true);
            $cancelUrl = Url::to(['payment/payment-cancel'], true);
            ...
            //auto -- auto submit to ccavenue
            //test/production -- is it test or production transaction 
            //local -- for credentials change, look over ccavenue file in components folder
            \app\components\Ccavenue::form($params, 'auto', 'test', 'local');
        }
