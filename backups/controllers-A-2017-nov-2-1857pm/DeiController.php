...
class DeiController extends Controller
{
    ...
    {
        if(empty($_REQUEST) || @$_REQUEST['amount']<10)
        {
            return $this->redirect(['/']);
        }
        $params = $_REQUEST;
    ...
    /*public function actionTransactionupdate()
    {
        ...
        $transaction_data = Array
                            (
                                "order_id" => "DEI17PA100018",
                                "tracking_id" => "1503161000",
                                "bank_ref_no" => "015679",
                                ...
                                "currency" => "INR",
                                "amount" => "10.0",
                                "billing_name" => "basaveswar",
                                "billing_address" => "Devrabbit,banjara hills",
                                "billing_city" => "Hyderabad",
                                "billing_state" => "Telangana",
                                "billing_zip" => "500034",
                                "billing_country" => "India",
                                "billing_tel" => "1234567890",
                                "billing_email" => "basaveswar.allaka@devrabbit.com",
                                "delivery_name" => "basaveswar",
                                "delivery_address" => "Devrabbit,banjara hills",
                                ...
                                "response_code" => "0",
                                "billing_notes" => "",
                                "trans_date" => "30/10/2017 11:38:18",
                                "bin_country" => "INDIA"
                            );
        //print_r($transaction_data);exit;
       Payments::update_paynow_transaction($transaction_data); exit; 
