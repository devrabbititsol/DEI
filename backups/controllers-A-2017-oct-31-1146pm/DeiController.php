...
class DeiController extends Controller
{
    ...
    public function actionProductpaymentsuccess()
    {
        try{
            ...
            if(@$session->get('current_product_id') != '')
            {
                ...
                mail('sk.ijaz@gmail.com', 'Response--Transaction-data', print_r($response, true));
                mail('sk.ijaz@gmail.com', 'Transaction-data', print_r($transaction_data, true)); 
    ...
    public function actionTransactionupdate()
    {
        ...
        $transaction_data = Array
                            (
                                "order_id" => "DEI17PS2001EE",
                                "tracking_id" => "106293664548",
                                "bank_ref_no" => "015679",
       ...
       Payments::update_transaction($transaction_data); exit;
