	...
	*/
    ...
    public function actionEditterritory($id)
    {
        try{
            ...
            $zones = Zones::get_all_zones();
            $states = States::get_states_by_zone_id($territory_details['zone_id']);
            $districts = Districts::get_districts_by_state_id($territory_details['state_id']);
    ...
    public function actionAds(){
        echo $this->render('//admin/underimplementation');
    }
    /************ Advt ACTIONS END ***************/
