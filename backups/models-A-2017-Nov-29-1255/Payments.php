...
class Payments extends Model
{
    ...
    public static function update_transaction($transaction_data)
    {
        try{
            ...
            $transaction_history['amount'] = $amount/((Yii::$app->params['GST']/100)+1);
            $transaction_history['gst_amount'] = $amount-($amount/((Yii::$app->params['GST']/100)+1));
