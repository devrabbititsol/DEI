...
*/
    ...
    public function hire_details_by_user($userId)
    {
        ...
        $query->select(['core_orders.order_id', 'core_orders.from_date', 'core_orders.to_date', 'core_orders.no_of_days', 'core_orders.order_status', 'core_orders.manual_order_code',
                    ...
                    'core_payments.payment_type','core_payments.payment_id','core_payments.before_order_id','core_payments.amount_actual','core_payments.amount_paid','core_payments.before_order_id'])
                ->from('core_orders')
                ->join('LEFT JOIN', 'core_payments', 'core_payments.payment_for = core_orders.order_id AND core_payments.payment_type=3')
                ->join('INNER JOIN', 'core_products', 'core_orders.product_id =core_products.product_id')
                ->join('INNER JOIN', 'core_product_categories', 'core_product_categories.category_id =core_products.category_id')
                ->where('core_orders.user_id=:userId', [':userId' => $userId])
                ->andWhere('core_orders.type="0"')
                //->andWhere('core_payments.payment_type="3"')//product orders
                //->groupBy(['core_orders.order_id'])
                ->orderBy(['core_orders.date_created' => SORT_DESC]);
    ...
    public function supply_details_by_user($userId) {
        ...
        $query->select(['core_products.product_id', 'core_products.manual_product_code', 'core_products.current_location', 'core_products.product_status',
                    'core_product_models.model_name', 'core_product_sub_categories.sub_category_name', 'core_product_categories.category_name','core_payments.payment_type','core_payments.payment_id','core_payments.before_order_id','core_payments.amount_actual','core_payments.amount_paid'])
                ...
                ->join('LEFT JOIN', 'core_payments', 'core_products.product_id =core_payments.payment_for')
                ->where('core_products.user_id=:userId', [':userId' => $userId])
                ->andWhere('core_products.product_type="0"')
                //->andWhere('core_payments.payment_type="1"')//product
    ...
    public function buy_details_by_user($userId) {
        ...
        $query->select(['core_orders.order_id', 'core_orders.from_date', 'core_orders.no_of_days', 'core_orders.order_status', 'core_orders.manual_order_code',
                    ...
                    'core_payments.payment_type','core_payments.payment_id','core_payments.before_order_id','core_payments.amount_actual','core_payments.amount_paid'])
    ...
    public function ad_details_by_user($userId) {
        ...
        return $query->select(['core_post_ads.*','core_post_ads_images.ads_image_id','core_post_ads_images.ad_image_url','core_post_ads_images.ad_image_status','core_payments.payment_type','core_payments.payment_id','core_payments.before_order_id','core_payments.amount_actual','core_payments.amount_paid'])
                    ->from('core_post_ads_images')
                    ->leftJoin('core_post_ads', 'core_post_ads.ad_id = core_post_ads_images.ad_id')
                    ->join('LEFT JOIN', 'core_payments', 'core_post_ads.ad_id =core_payments.payment_for')
