...
class Mail_settings extends Model
{
    ...
    public function get_quote_message_to_admin($quote_details)
    {
        ...
        if($quote_details['quotation_type'] == 'sale')
            $quote_details['quotation_type'] = 'buy';
        ...
        $message="Dear Admin<p>Got a new quote enquiry</p>"
                ...
                . "<strong>I need to : </strong>".$quote_details['quotation_type']."<br/>"
                . "<strong>Start Date : </strong>".$quote_details['start_date']."<br/>"
                . "<strong>Duration : </strong>".$quote_details['duration']." ".$quote_details['duration_type']."<br/>"
                . "<strong>Comments : </strong>".$quote_details['comments']."<br/>"
                . "<strong>I use this for : </strong>".$quote_details['job_description']."<br/>"
                . "</p>"
                . "<p>"
