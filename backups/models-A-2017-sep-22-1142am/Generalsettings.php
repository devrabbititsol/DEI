...
class Generalsettings extends Model
{
    ...
    public static function create_transaction_order_id($payment_type,$payment_module,$package_type,$advt_primary_key)
    {
        $transaction_order_id = "DEI".date('y').$payment_type.$payment_module.$package_type;
        $transaction_order_id .= strtoupper(str_pad(dechex($advt_primary_key), 5, '0', STR_PAD_LEFT));
