                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php } elseif ($value['order_status'] == 2) { ?>
                                        <td>Approved by Sales Manager</td>
                                    ...
                                    <?php } else { ?>
                                        <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp; &nbsp; <a href="javascript:void(0);" onclick="deleteOrder(<?php echo $value['order_id']; ?>);"><i class="fa fa-lg fa-trash" style="color:red;"></i></a></td>
                                    <?php } ?>
                                </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <table id="supplier_table" class="display datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Approved by Data Operator</td>
                                    <?php }elseif ($value['product_status'] == 3) { ?>
                                    <td>Approved by Sales Ex</td>
                                    ...
                                    <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp; &nbsp; 
                                        ...
                                        <a href="javascript:void(0);" onclick="deleteProduct(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-trash" style="color:red;"></i></a></td>
                                    <?php } ?>
                                </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <table id="sale_table" class="display datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Pending</td>
                                    <?php }elseif ($value['ad_status'] == 1) { ?>
                                    <td>Approved</td>
                                    <?php }elseif ($value['ad_status'] == 2) { ?>
                                    <td>Closed</td>
                                    <?php } ?>
                                    <td>
                                        <?php if ($value['ad_status'] < 2) { ?>
                                        <a href="javascript:void(0);" onclick="deleteAd(<?php echo $value['ad_id']; ?>);"><i class="fa fa-lg fa-trash" style="color:red;"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php }?>
