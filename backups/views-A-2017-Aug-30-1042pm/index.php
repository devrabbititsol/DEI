    ...
    ?>
      <div class="item <?php if($i==0) echo "active";?>" >
        ...
        <a href="<?php echo @$ad->ad_weblink;?>" target="_blank">
            <center>
                <img src="<?php echo $ad_image; ?>" alt="<?php echo $ad->ad_title;?>" style="height:350px; width: auto;">
            </center>
        </a>
    </div>
    <?php $i++; endforeach; ?>
		...
		<div class="service_box">
			...
			<div class="sevicebox_content">
			   <h4><?php echo @$array_hire_services[$index]['category_name'];?></h4>
				...
				<div class="col-sm-4"><p>Year Of Manufacture</p><?php echo @$array_hire_services[$index]['manufacture_year'];?></div>
				<div class="clearfix"></div>
				<div class="hr"></div>
				<div class="footer">
		...
		<div class="service_box">
			...
			<div class="sevicebox_content">
			   <h4><?php echo @$array_sale_services[$index]['category_name'];?></h4>
				...
				<div class="col-sm-4"><p>Year of Manufacture</p><?php echo @$array_sale_services[$index]['manufacture_year'];?></div>
				<div class="clearfix"></div>
				<div class="hr"></div>
				<div class="footer">
					<div class="col-md-4 col-sm-4">
                ...
                <form action="facebookad" method="post" enctype="multipart/form-data" id="adform">
                    ...
                    <div class="modal-post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                <input type="url" class="form-control" placeholder="Website URL" name="weblink">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                <input type="file" class="form-control" placeholder="Upload Your Images " name="post_file[]" required multiple="multiple" max-uploads = 6>

                                <label style="color: red;padding-top: 10px;"> Multiple Image Upload (Recommended Dimensions:Less than 1000X360). 7 pics Maximum</label> 
                                </div>
                            </div>
                        </div>
                        <div class="row pt20">
