                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <input type="submit" name="login-submit" class="form-control btn btn-login" value="LOGIN" onclick="return loginValidate()">
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        $.ajax({
            ...
            success: function(response){
                if(response == 2)
                {
                    ...
                    window.location.href = "<?php echo Yii::$app->request->referrer;?>"
                }
                else if(response == 1)
                {
                    $(".loginformcls").hide();
