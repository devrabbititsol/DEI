<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Total Orders Payment's List</h2>
        </header>
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="order-payment-datatable">
                <thead>
                    <tr>
                        <th>Payment Order Id</th>
                        <th>Actual Amount</th>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Total Quotes Payment's List</h2>
        </header>
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="quote-payment-datatable">
                <thead>
                    <tr>
                        <th>Payment Order Id</th>
                        <th>Actual Amount</th>
                ...
                <tbody>
                    <?php
                    $i = 1;
                    foreach ($quote_payment_details as $payment) {
                        echo '<tr class="gradeX">
                        <td>' . $payment['before_order_id'] . '</td>
                        <td>' . number_format($payment['amount_actual'],2) . '</td>
                        <td>' . number_format($payment['amount_paid'],2) . '</td>
...
$(document).ready(function() {
    ...
    $('#order-payment-datatable').DataTable({"aaSorting": [],"oLanguage": {"sLengthMenu": "\_MENU_"}});
    $('#quote-payment-datatable').DataTable({"aaSorting": [],"oLanguage": {"sLengthMenu": "\_MENU_"}});
} );
</script>