<section role="main" class="content-body">
    ...
    <form class="form-horizontal form-dtls" method="post" action="<?= Yii::$app->params['SITE_URL'] ?>admin/savezone" id="addzone">
        <div class="col-md-12" >
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="zone_name" name="zone_name" class="form-control" placeholder="Zone*" required="required"  />
                                            </div>
                                        </div>
                                    </div>
                                </div>
