    ...
    ?>
      <div class="item <?php if($i==0) echo "active";?>" >
        ...
        <a href="<?php echo @$ad->ad_weblink;?>" target="_blank">
            <center>
                <img class="img-responsive" src="<?php echo $ad_image; ?>" alt="<?php echo $ad->ad_title;?>" style="width: auto;">
            </center>
        </a>
    </div>
    <?php $i++; endforeach; ?>
...
<section class="gap pt40" style="height:600px;">
<div class="container">
	<div class="row">
    <div class="main_headding nomb">
            <h2><span>Our</span> advertisers</h2>
  ...
  <div class="carousel-inner" role="listbox">
    ...
    $ad = (object)$ad;
    $ad_image= @$ad->ad_image_url;  
    //list($w, $h) = @getimagesize($ad_image);
    $w=100;$h=100;
    ?>
      <div class="item <?php if($i==0) echo "active";?>" >
          <center><h4>Name of Advertiser:&nbsp;<strong><?php echo @$ad->company_name; ?></strong></h4></center>
        <a href="<?php echo @$ad->ad_weblink;?>" target="_blank">
            <center>
                <img style="width:<?php if ($w > 720){ echo "720"; }else{echo $w;}?>px;height:<?php if ($h > 360){ echo "360"; }else{echo $h;}?>px;" src="<?php echo $ad_image; ?>" alt="<?php echo $ad->ad_title;?>" style="height:350px; width: auto;">
            </center>
        </a>
    </div>
    <?php $i++; endforeach; ?>
                    ...
                    <div class="modal-post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <label style="color: red;padding-top: 10px;"> Multiple Image Upload (Recommended between 300px * 300px and 1400px * 360px). 7 pics Maximum</label> 
                                </div>
                            </div>
                        </div>
                        <div class="row pt20">
            ...
            <div class="modal-body">
                ...
                <form action="facebookad" method="post" enctype="multipart/form-data" id="adform">
                    ...
                    <div class="modal-post">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                               <input type="hidden" id="advt_images" required class="form-control" placeholder="Upload Your Images " name="advt_images" required multiple="multiple" max-uploads = 6>
                          </div>
...
{
    if($("#advt_images").val() != '' && $("#advt_images").val() != '""')
    {
        $("#advtimages").removeClass('error');
        $("#adform").submit();
    }
