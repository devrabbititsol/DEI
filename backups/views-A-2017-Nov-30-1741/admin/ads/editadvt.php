...
<section role="main" class="content-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control datepicker" style="cursor:pointer;" placeholder="Select a date" id="expire" value="<?= date("m-d-Y",strtotime($ad['ad_expire'])) ?>" name="expire" required>
                                        </div>
                                    </div>
                                </div> 
    ...
    foreach($ad_images as $index=>$image)
    {
        $image = (object)$image;
            ...
            //if($image->ad_type == 1 && $image->ad_image_status != 3)
            ...
            /*else if($image->ad_type == 2 && $image->ad_image_status != 3)
            {
                $video_link = str_replace("watch?v=",'v/', $image->ad_image_url);
                $gallery .= '<div class="imagealt"><a class="pull-left mb-xs" href="'.$video_link.'">
                            <div class="img-responsive">
                                <embed src="'.$video_link.'" allowscriptaccess="always" allowfullscreen="true"></embed>
                            </div>
                        </a>
                        <div class="imagealtctrl">
                        <i onclick="deleteadImage('.$image->ads_image_id.')"><i class="fa fa-trash"></i></i></div></div>';
            }*/
    }
    ?>
