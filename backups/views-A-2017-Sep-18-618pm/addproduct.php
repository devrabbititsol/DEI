                    ...
                    <div class="tab-pane" role="tabpanel" id="step4">
                        ...
                        <div class="col-md-6 pricing">
                          <div class="form-group form-inline">
                              <input type="text" name="hire_price" id="hire_price" placeholder="Hire Price *" style="width: 70%" class="form-control" required="required">
                                <select name="hire_price_range" id="hire_price_range"  class="form-control pull-right" style="font-family: 'FontAwesome', Helvetica; width: 28%">
                                    <option value="">&#8377;</option>
                        ...
                        <div class="col-md-6 sale_price">
                          <div class="form-group form-inline">
                                <input type="text" name="sale_price" id="sale_price" placeholder="Sale Price *" style="width: 70%" class="form-control" required="required">
                                <select name="sale_price_range" id="sale_price_range" class="form-control pull-right" style="font-family: 'FontAwesome', Helvetica; width: 28%">
                                    <option value="">&#8377;</option>
                                    <option value="crore">CRORES</option>
                                    <option value="lack">LAKHS</option>
                                    <option value="thousand">THOUSANDS</option>
