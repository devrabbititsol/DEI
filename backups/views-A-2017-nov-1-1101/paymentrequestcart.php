<form method="POST" name="customerData" id="customerData" action="paymentcheckout">
    ...
    <table width="50%" height="100" border="1" align="center">
        <tbody>
            ...
            <tr>
                <td>Balance	:</td><td><input type="text" name="amount" value="<?php echo $params['amount']; ?>" max="<?php echo $params['amount']; ?>" min="1000" required="required"> (Minimum 1000 INR)</td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td><td><input class="btn btn-default" type="submit" value="CheckOut"><a class="btn btn-default" href="<?php  echo 'paymentrequestcancel'; ?>">cancel</a></td>
            </tr>
        </tbody>
    </table>
</form>
