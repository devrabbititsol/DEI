                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="" role="form" id="changepasswordform" name="changepasswordform" method="post" action="updatepassword">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Enter Your New Password with minimum 8 characters *" required="required" minlength="8">
                                </div>
                                <div class="form-group">
