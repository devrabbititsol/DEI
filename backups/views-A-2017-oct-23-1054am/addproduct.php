        ...
        <div class="wizard-inner">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="productdata" class="disabled">
                        <a href="#step4" data-toggle="tab" aria-controls="complete" role="tab" title="step <?php if(Yii::$app->user->isGuest) { echo "4"; } else { echo "2";} ?>">
                                Step <span><?php if(Yii::$app->user->isGuest) { echo "4"; } else { echo "2";} ?></span>
                        </a>
                </li>

                <li role="productdata" class="disabled">
                        <a href="#step5" data-toggle="tab" aria-controls="complete" role="tab" title="step <?php if(Yii::$app->user->isGuest) { echo "5"; } else { echo "3";} ?>">
                                Step <span><?php if(Yii::$app->user->isGuest) { echo "5"; } else { echo "3";} ?></span>
                        </a>
                </li>
                <li role="presentation" class="disabled">
                        <a href="#step6" data-toggle="tab" aria-controls="complete" role="tab" title="step <?php if(Yii::$app->user->isGuest) { echo "6"; } else { echo "4";} ?>">
        ...
        <form role="form" method="post" action="saveproduct" name="addproduct" id="addproduct">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane <?php if(Yii::$app->user->isGuest) { echo "active"; }?>" role="tabpanel" id="step1">
                        ...
                        <div class="col-md-4 col-md-offset-4 error-message" style="display: none;">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                                <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Enter Mobile Number *" required="required" minlength="10" maxlength="13" onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                ...
                <?php } ?>
                    <div class="tab-pane <?php if(!Yii::$app->user->isGuest) { echo "active"; }?>" role="tabpanel" id="step3">
                        ...
                        <input type="hidden" name="product_type" id="product_type"  value="<?php if(@$_GET['product_type']=="hire") echo "0";else if(@$_GET['product_type']=="sale") echo '1';else if(@$_GET['product_type']=="both") echo '2'; ?>"  >
                        <div class="col-md-6">
                          <div class="form-group">
                        ...
                        <div class="col-md-12 dynamic boomlength">
                          <div class="form-group">
                                <input type="number" id="boom_length" name="boom_length" step="0.01" class="form-control" placeholder="Boom length (in meters) *" required="required" />
                    ...
                    <div class="tab-pane" role="tabpanel" id="step4">
                        ...
                        <div class="col-md-6 dynamic fly_jib">
                          <div class="form-group">
                                <!--<div class="input-group">-->
                                    <input type="number" name="fly_jib" id="fly_jib" step="0.01" class="form-control" placeholder="Fly Jib (Length In meters)" />
                        ...
                        <div class="col-md-6 dynamic luffing_jib">
                          <div class="form-group">
                                <!-- <div class="input-group"> -->
                                        <input type="number" name="luffing_jib" id="luffing_jib" step="0.01" class="form-control" placeholder="Luffing Jib (Length In meters)"/>
                                        <!-- <div class="input-group-addon bg-dei"><i class="fa fa-check"></i></div> -->
                                <!-- </div> -->
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 dimensions">
                            <div class="col-md-4 dimensions" style="padding-left:0px;">
                                <div class="form-group">  
                                    <input type="text" name="length" id="length" placeholder="Length in meters" class="form-control" maxlength=4 onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g, '')" > 
                                </div>                        
                            </div>                        
                            <div class="col-md-4 dimensions" style="padding-left:0px;">
                                <div class="form-group">                                
                                    <input type="text" name="width" id="width" placeholder="Width in meters" class="form-control" maxlength=4 onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g, '')" > 
                                </div>                        
                            </div>                        
                            <div class="col-md-4 dimensions" style="padding-left:0px;padding-right: 0px">
                                <div class="form-group">                                
                                    <input type="text" name="height" id="height" placeholder="Height in meters" class="form-control" maxlength=4 onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g, '')" >
                                </div>                        
                            </div>                    
                        </div>
                        ...
                        <div class="col-md-6 pricing">
                          <div class="form-group row">
                              <div class="col-md-8">
                                  <input type="text" name="hire_price" id="hire_price" placeholder="Hire Price *" class="form-control" required="required" min="1">
                              </div>
                              <div class="col-md-4">
                                <select name="hire_price_range" id="hire_price_range"  class="form-control pull-right" style="font-family: 'FontAwesome', Helvetica;">
                                    <option value="">&#8377;</option>
                                    <option value="crore">CRORES</option>
                                    <option value="lack">LAKHS</option>
                                    <option value="thousand">THOUSANDS</option>
                                    <option value="por">POR(Price On Request)</option>
                                </select>
                              </div>
                          </div>
                        </div>
                        <div class="col-md-6 sale_price">
                          <div class="form-group row">
                              <div class="col-md-8">
                                <input type="text" name="sale_price" id="sale_price" placeholder="Sale Price *" class="form-control" required="required" min="1">
                              </div>
                              <div class="col-md-4">
                                <select name="sale_price_range" id="sale_price_range" class="form-control pull-right" style="font-family: 'FontAwesome', Helvetica;">
                                    <option value="">&#8377;</option>
                                    <option value="crore">CRORES</option>
                                    <option value="lack">LAKHS</option>
                                    <option value="thousand">THOUSANDS</option>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        ...
                        <div class="head-2 col-md-12">
                                <h2><?php if(@$_GET['product_type']=='sale' || @$_GET['product_type']=='both')
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                              <div class="checkbox">
                                    <label style="<?php if(@$_GET['product_type'] == 'both') echo 'visibility: hidden;'; ?>">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step6">
                        ...
                        <input type="hidden" value="<?php if(isset($_GET['package_amount'])){ echo @$_GET['package_amount']; }?>" name="package_amount" id="package_amount" >
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            ...
                                            <div>Promotional Offer (Valid upto <?= date('F dS, Y',strtotime(Yii::$app->params['PROMOTIONAL_OFFER_UPTO'])) ?>)</div>
                                            </strong>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <strong><div class="paidamount"><?php if(isset($_GET['package_amount'])){ echo $_GET['package_amount']; }?> INR</div>
                                            <div>Paid Premium (Valid upto <?= Yii::$app->params['PRODUCT_PAID_DAYS'] ?>)</div>
                                            </strong>
                                        </div>
                                    </div>
                                </div>
		...
		for(var i = 0; i < data.fields.length; i++) {
		    ...
		    $("#life_tax_details").select2({ placeholder: 'Life Tax Details '});
                ...
                <?php if(isset($_GET['sub_category'])){ ?>
                     $('#subcategory_id').val(<?php echo @$_GET['sub_category']; ?>);   
                <?php } ?>
	    }
	});
	<?php } ?>
      ...
      $('#hire_price, #sale_price').keypress(function(event) {
        if ((event.which != 46 || $(this).val().indexOf('.') != -1 || event.which != 44 || $(this).val().indexOf(',') != 0) && (event.which == 45 || event.which < 43 || event.which > 57)) {
          event.preventDefault();
        }
      });
...
$('#hire_price_range').change(function(){
    if($(this).val() == 'por')
    {
        $('#hire_price').val('PRICE ON REQUEST');
        $('#hire_price').attr('readonly', true);
        $('#hire_price').attr('min', false);
    }
    else
    {
        $('#hire_price').val('');
        $('#hire_price').attr('readonly', false);
        $('#hire_price').attr({'min': 1});
    }
});
$('#sale_price_range').change(function(){
    if($(this).val() == 'por')
    {
        $('#sale_price').val('PRICE ON REQUEST');
        $('#sale_price').attr('readonly', true);
        $('#sale_price').attr('min', false);
    }
    else
    {
        $('#sale_price').val('');
        $('#sale_price').attr('readonly', false);
        $('#sale_price').attr({'min': 1});
    }
});
...
function getcapacityamount()
{
    ...
    if(capacity != '')
    {
        $.ajax({
            ...
            type: "post",
            data: {"capacity": capacity,'category_id':category_id,'sub_category_id':sub_category_id, "_csrf": "<?php echo Yii::$app->request->csrfToken; ?>" } ,
            dataType: 'json',
            success: function (data) {
...
$('#state_id').change(function(){
    ...
    $.ajax({
        url: "<?= Yii::$app->params['SITE_URL'] ?>admin/getdistrictsbystate",
...
function validateProductimage()
{
    if($("#addproduct").valid())
    {
        ...
        else
        {
            ...
            $(".error-message").show(); 
            //$(".uploadlabel").attr("tabindex",-1).focus();
            return false;
        }
        $(".error-message").hide(); 
    }
