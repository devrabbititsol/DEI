...
$('#zone_id').change(function(){
    ...
    var user_type = <?php echo $role_details['role_id']; ?>;
    $.ajax({
        url: "<?= Yii::$app->params['SITE_URL'] ?>admin/getstatesbyzones",
        data : {user_type: user_type, zone_id: $(this).val(), "_csrf": "<?php echo Yii::$app->request->csrfToken; ?>" },
        dataType: 'json',
...
$('#state_id').change(function(){
    ...
    $.ajax({
        ...
        data : {user_type: user_type, state_id: $(this).val(), "_csrf": "<?php echo Yii::$app->request->csrfToken; ?>" },
        dataType: 'json',
        success: function(data){
