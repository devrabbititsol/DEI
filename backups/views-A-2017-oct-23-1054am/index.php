			...
			<div class="item active">
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="#"style="color:#ea2e2e;">Call Us</a> &nbsp; +91- 9246611422</h4> -->
                                <h2>Urgent Requirement at Guwahati, Assam: 400 Ton All Terrian Crane</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4>  
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="#"style="color:#ea2e2e;">Contact Parminder Singh</a>&nbsp; +91- 9725289394</h4>-->
                                <h2>Urgent Requirement at Andhra Pradesh & Telangana: 120 Tons All Terrian Crane</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4> 
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>Need 450 Tons Crawler Crane at Sangli, Maharashtra</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigquipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4> 
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			<div class="item">
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>Need Two 150 Tons Crane at Jharkhand and Bihar for Railway Erection - 8 to 9 months</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4>  
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>Urgent Requirement of 70 Tons Crawler for 6 months at Telangana for the Godavari Project</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL'];  ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91-83338 93338</a></h4> 
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
