		  ...
		  <div class="carousel-inner" role="listbox">
			<div class="item active">
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="#"style="color:#ea2e2e;">Call Us</a> &nbsp; +91- 9246611422</h4> -->
                                <h2>New URGENT Requirement for Purchase : 40T , 100T, 200T, 350T Cranes</h2>
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>New URGENT Requirement for Purchase : 40Ton ALL-TERRAIN Crane</h2>
			...
			<div class="item">
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>New URGENT Requirement for Purchase : 100Ton ALL-TERRAIN Crane</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4>  
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>New URGENT Requirement for Purchase : 200Ton ALL-TERRAIN Crane</h2>
                                <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL'];  ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91-83338 93338</a></h4> 
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			  ...
			  <!--<h2>POST YOUR CLASSIFIEDS HERE</h2>
              <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for placing your classifieds with us</h4>-->
			   <h2>New URGENT Requirement for Purchase : 350Ton ALL-TERRAIN Crane</h2>
                           <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL'];  ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91-83338 93338</a></h4>
