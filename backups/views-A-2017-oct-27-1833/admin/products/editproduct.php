    ...
    <div class="row">
        ...
        <div class="tabs tabs-danger">
            <ul class="nav nav-tabs">
                ...
                <?php if(\app\models\User::checkAccess('image_action')){ ?>
                <li class="">
                    <a href="#popular5" data-toggle="tab" aria-expanded="true"><i class="fa fa-align-left"></i> Images Edit</a>
                </li>
                <li class="dynamic load_chart">
                    <a href="#popular6" data-toggle="tab" aria-expanded="true"><i class="fa fa-align-left"></i> Load Chart Edit</a>
                </li>
                <?php } ?>
            </ul>
            <div class="tab-content">
                <div id="popular4" class="tab-pane active">
                        ...
                        <section class="panel">
                            ...
                            <input type="hidden" name="product_type" value="<?= $product_details['product_type'] ?>">
                            <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group row">
                                                <div class="col-md-7">
                                                <input type="text" name="hire_price" value="<?php if($product_details['hire_price']=='-1'){ echo "PRICE ON REQUEST"; } else{echo $product_details['hire_price'];} ?>" id="hire_price" placeholder="Hire Price *" class="form-control" required="required"  <?php if($product_details['hire_price']=='-1') echo "readonly"; else echo 'min="1"'; ?> >
                                                </div>
                                                <div class="col-md-5">
                                                    <select name="hire_price_range" id="hire_price_range"  class="form-control pull-right" style="font-family: 'FontAwesome', Helvetica;">
                                                        <option value="" <?php if($product_details['hire_price']!='-1'){ echo "selected"; } ?>>&#8377;</option>
                                                        <option value="crore">CRORES</option>
                                                        <option value="lack">LAKHS</option>
                                                        <option value="thousand">THOUSANDS</option>
                                                        <option value="por" <?php if($product_details['hire_price']=='-1'){ echo "selected"; } ?>>POR(Price On Request)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 sale_price">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group row">
                                                <div class="col-md-7">
                                                    <input type="text" name="sale_price" value="<?php if($product_details['sale_price']=='-1'){ echo "PRICE ON REQUEST"; } else{echo $product_details['sale_price'];} ?>" id="sale_price" placeholder="Sale Price *" class="form-control" required="required" <?php if($product_details['sale_price']=='-1') echo "readonly"; else echo 'min="1"'; ?>>
                                                </div>
                                                <div class="col-md-5">
                                                    <select name="sale_price_range" id="sale_price_range"  class="form-control pull-right" style="font-family: 'FontAwesome', Helvetica;">
                                                        <option value="" <?php if($product_details['sale_price']!='-1'){ echo "selected"; } ?>>&#8377;</option>
                                                        <option value="crore">CRORES</option>
                                                        <option value="lack">LAKHS</option>
                                                        <option value="thousand">THOUSANDS</option>
                                                        <option value="por" <?php if($product_details['sale_price']=='-1'){ echo "selected"; } ?>>POR(Price On Request)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Expires On : </label>
                                        <div class="col-sm-8">
                                            <input type="text" name="product_expires_on" id="product_expires_on" class="form-control datepicker" value="<?= date('m/d/Y', strtotime($product_details['product_expires_on']))?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <?php } ?>
                                <?php 
                                    $gallery = '';$edit_gallery = ''; $load_charts ='';$edit_load_charts =''; $editimageurl = Yii::$app->params['SITE_URL'] ."uploads/noimage.png";$editimagename = '';
                                    foreach($product_images as $index=>$image)
                                    {
                                        ...
                                        if($image->image_type == 1)
                                        {
                                            ...
                                            $gallery .= '<div class="imagealt"><a class="pull-left mb-xs" href="'.$image->image_url.'">
                                            ...
                                            $edit_gallery .= '<div class="imagealt"><a class="pull-left mb-xs" href="'.$image->image_url.'">
                                                            <div class="img-responsive">
                                                                <img src="'.$image->image_url.'?version='.rand(0,1000).'">
                                                            </div>
                                                        </a>
                                                        <div class="imagealtctrl">
                                        ...
                                        else if($image->image_type == 2)
                                        {
                                            ...
                                            $edit_load_charts .= '<div class="imagealt"><a class="pull-left mb-xs mr-xs" href="'.$image->image_url.'">
                                                                <div class="img-responsive">
                                                                    <img src="'.$image->image_url.'">
                                                                </div>
                                                            </a>
                                ...
                                <div class="col-md-12 dynamic load_chart">
                                    <section class="panel">
                                        ...
                                        <h2 class="panel-title">Product Load Charts</h2>
                ...
                <div id="popular6" class="tab-pane dynamic load_chart">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <section class="panel">
