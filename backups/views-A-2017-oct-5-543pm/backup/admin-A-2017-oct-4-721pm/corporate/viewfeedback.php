<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right pr-xlg">
            <ol class="breadcrumbs">
                ...
                <li><span>Feedback Details</span></li>
            </ol>
        </div>
    </header>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <a href="<?= Yii::$app->params['SITE_URL'] ?>admin/corporate" class="mb-xs mt-xs mr-xs btn btn-primary btn-block">Back To Feedback List</a>
        </div>
    </div>
    <div class="row">
        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">Feedback Details</h2>
            </header>
            <div class="panel-body">
                <div>
                    <h4 class="mb-xlg">Feedback Details</h4>
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label><?php echo ucwords($feedback['name']); ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label"> : </label>
                            <div class="col-sm-8">
                                <label><?php echo $feedback['phone']; ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label"> : </label>
                            <div class="col-sm-8">
                                <label><?php echo $feedback['email']; ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label"> : </label>
                            <div class="col-sm-8">
                                <label><?php echo $feedback['message']; ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label"> : </label>
                            <div class="col-sm-8">
                                <label><?php echo $feedback['date_created']; ?></label>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <section class="panel">
            ...
            <footer class="panel-footer">
                <form method="post" action="<?= Yii::$app->params['SITE_URL'] ?>admin/addcomment" name="addcomment" id="addcomment">
                    <input type="hidden" name="comment_belongs_to" id="comment_belongs_to" value="<?php echo $feedback['feedback_id']; ?>">
                    <input type="hidden" name="comment_type" id="comment_type" value="7"><!-- comment type -->
