			...
			<div class="item active">
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="#"style="color:#ea2e2e;">Call Us</a> &nbsp; +91- 9246611422</h4> -->
                               ...
                               <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or +91.83338 93338</h4>  
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                               ...
                               <h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigquipmentsindia.com/contact</a> or +91.83338 93338</h4> 
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			<div class="item">
