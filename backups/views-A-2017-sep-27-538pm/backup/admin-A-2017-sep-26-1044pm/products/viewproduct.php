...
<section role="main" class="content-body">
    ...
    <div class="col-md-12">
        <footer class="panel-footer text-center">
            ...
            <?php } if($product_details['employee_id'] == '' || $product_details['employee_id'] == '0'){?>
            <button type="button" class="btn btn-info" onclick="productAssign();" data-toggle="modal" data-target="#postad_modal">Assign</button>
            <?php } ?>
