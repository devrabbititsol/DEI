<section role="main" class="content-body">
    ...
    <form class="form-horizontal form-dtls" method="post" action="<?= Yii::$app->params['SITE_URL'] ?>admin/updatedistrict" id="editdistrict">
        <div class="col-md-12" >
                ...
                <div class="tab-content">
                    <div id="popular4" class="tab-pane active">
                        ...
                        <section class="panel">
                            ...
                            <h2 class="panel-title">Edit District</h2>
                            <input type="hidden" name="district_id" id="district_id" value="<?php echo $district_details['district_id']; ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="district_name" name="district_name" value="<?php echo $district_details['district_name']; ?>" class="form-control" placeholder="Zone*" required="required"  />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <select class="form-control" id="zone_id" name="zone_id" required="required">
                                                    ...
                                                    foreach ($zones as $zone)
                                                        if ($zone['zone_status'] == 1)
                                                            echo "<option value='".$zone['zone_id']."'".(($zone['zone_id']==$district_details['zone_id'])?'selected="selected"':"")." >" . strtoupper($zone['zone_name']) . "</option>";
                                                    ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" id="state_id" name="state_id" required="required">
                                                    ...
                                                    foreach ($states as $state)
                                                            echo "<option value='".$state['state_id']."'".(($state['state_id']==$district_details['state_id'])?'selected="selected"':"")." >" . strtoupper($state['state_name']) . "</option>";
                                                    ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" id="district_status" name="district_status" required="required">
                                                    ...
                                                    <option value="0" <?php if($district_details['district_status'] == 0) echo "selected='selected'" ?>>Inactive</option>
                                                    <option value="1" <?php if($district_details['district_status'] == 1) echo "selected='selected'" ?>>Active</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
