                        ...
                        <div class="nano-content">
                            <nav id="menu" class="nav-main" role="navigation">
                                <ul class="nav nav-main">
                                    ...
                                    <li class="nav-parent" <?php if(!\app\models\User::checkAccess('setup_action')) echo "style='display:none;'"; ?>>
                                        <a>
                                        ...
                                        <ul class="nav nav-children">
                                            <li>
                                                <a href="<?= Yii::$app->params['SITE_URL'].'admin/zones' ?>">Zones</a>
                                                <a href="<?= Yii::$app->params['SITE_URL'].'admin/states' ?>">States</a>
                                                <a href="<?= Yii::$app->params['SITE_URL'].'admin/districts' ?>">Districts</a>
