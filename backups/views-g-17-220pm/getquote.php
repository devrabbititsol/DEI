            ...
            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="radio">
                                                            ...
                                                            <label for="quotation_type1" class="css-label radGroup1">Ready To Use</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="radio">
                                                            <input type="radio" name="quotation_type" id="quotation_type2" class="css-checkbox" value="sale" />
                                                            <label for="quotation_type2" class="css-label radGroup1">Planning For Budgeting</label>
                ...
                <div class="col-md-12" id="step4">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="main_inner_head text-normal">
                                    <h3> Which Best Describe Your Job?</h3>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-3">
