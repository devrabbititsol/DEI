...
class Ads extends Model
{
    ...
    public function update_ad_status($id,$type)
    {
        ...
        $result2 = $query->createCommand()->update('core_post_ads_images', ['ad_image_status' => $type], 'ad_id = "'.$id.'"')->execute();
    ...
    public function update_ad_image_status($id,$type)
    {
        ...
        $result = $query->createCommand()->update('core_post_ads_images', ['ad_image_status' => $type], 'ads_image_id = "'.$id.'"')->execute();
