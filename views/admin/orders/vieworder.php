...
<section role="main" class="content-body">
    ...
    <div class="col-md-12">
        <footer class="panel-footer text-center">
            ...
            <?php }?>
            <?php if(($role_details['role_id'] == 2 || $role_details['role_id'] == 8)){
                if($order_details['employee_id'] == '' || $order_details['employee_id'] == '0'){ ?>
            ...
            <?php if(\app\models\User::checkAccess('payment_action')) { ?>
                <form method="post" id="request_payment" action="<?= Yii::$app->params['SITE_URL'] ?>admin/orderspaymentrequest">
                    ...
                    <input type="hidden" id="order_id" name="order_id" value="<?php echo $order_details['order_id'];?>">
                    <input type="hidden" id="order_id" name="manual_order_code" value="<?php echo $order_details['manual_order_code'];?>">
                    <input type="hidden" id="order_type" name="order_type" value="<?php echo $order_details['type'];?>">
                    <input type="hidden" id="product_id" name="product_id" value="<?php echo $order_details['product_id'];?>">
                    <input type="hidden" id="user_id" name="user_id" value="<?php echo $order_details['user_id'];?>">
                    <input type="hidden" id="package_type" name="package_type" value="<?php echo $product_details['package_type'];?>">
                    <input type="hidden" id="payment_type" name="payment_type" value="3">
                </form>
