        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div>
                    ...
                    <form class="" method="post" action="<?= Yii::$app->params['SITE_URL'] ?>admin/generateorderpaymentlink" id="generatepaymentlink">
                    ...
                    <input type="hidden" name="order_type" id="order_type" value="<?php echo @$payment_details['order_type']; ?>" >
                    <input type="hidden" name="package_type" id="package_type" value="<?php echo @$payment_details['package_type']; ?>" >
                    <input type="hidden" name="manual_order_code" id="manual_order_code" value="<?php echo @$payment_details['manual_order_code']; ?>" >
                    <div class="col-md-12">
                    ...
                    <footer class="col-md-offset-1">
                        ...
                        <?php if($payment_type == 3) { ?>
                            <a href="<?php echo Yii::$app->params['SITE_URL'].'admin/vieworder/'.$payment_details['order_id']; ?>" class="btn btn-default">Cancel</a>
                        <?php } else if($payment_type == 4) { ?>
                            <a href="<?php echo Yii::$app->params['SITE_URL'].'admin/viewquote/'.$payment_details['quotation_id']; ?>" class="btn btn-default">Cancel</a>
                        <?php } ?>
