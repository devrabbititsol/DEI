...
?>
<div class="row">
    <div class="post-job col-md-12 pb-10">
        <form action="searchproducts" method="post" id="searchform" class="pt-10">
            <input type="hidden" name="_csrf" value="<?= Yii::$app->request->getCsrfToken() ?>" />
            <div class="col-md-6 col-md-offset-2">
                <input placeholder="Search for Equipments" style="border:1px solid red;" class="col-md-6 form-control" required="" type="text" name="global_search" id="globalSearch"> 
            </div>
            <div class="col-md-2">
                <button type="submit" class="btn btn-bei btn-bt form-control col-md-1">Search</button>
            </div>
        </form>		
    </div>
</div>
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner" role="listbox">
			<div class="item active">
			  <img src="images/banner-11.png" alt="ss">
			  <div class="carousel-caption">
				...
				<h4><a href="#"style="color:#ea2e2e;">Call Us</a> &nbsp; +91- 9246611422</h4> -->
                                <h2>Urgent Requirement at Sivam, Bihar : Two (2) 150 Ton Hydraulic Truck Cranes</h2>
                                <h4><a href="mailto:info@bigequipmentsindia.com"style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91-83338 93338</a></h4>  
				<!-- end add by DEI IT Team -->
			  	<!--<h4>Pioneering an innovative and easier way to facilitate equipments related logistics, across India.</h4>-->
                        ...
                        <div class="item">
			  <img src="images/banner-22.png" alt="ss">
			  <div class="carousel-caption">
				...
				<h4><a href="#"style="color:#ea2e2e;">Contact Parminder Singh</a>&nbsp; +91- 9725289394</h4>-->
                                <h2>Urgent Requirement at Andhra Pradesh Border : 75-80 Ton Crawler Crane</h2>
                                <h4><a href="mailto:info@bigequipmentsindia.com" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4> 
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>Urgent Requirement at Andhra Pradesh Border : 150 Ton Crawler Crane</h2>
                                <h4><a href="mailto:info@bigequipmentsindia.com" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4> 
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			<div class="item">
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>Urgent Requirement at Maharashtra : Ten (10) 20-25 Ton Hyva Tata Dumpers</h2>
                                <h4><a href="mailto:info@bigequipmentsindia.com" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91.83338 93338</a></h4>  
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			  ...
			  <div class="carousel-caption">
				...
				<h4><a href="<?php echo Yii::$app->params['SITE_URL']; ?>contact" style="color:#ea2e2e;">Contact us</a> for more details</h4>-->
                                <h2>Urgent Requirement at Nellore, Andhra Pradesh : 250/350 Ton Crawler Crane</h2>
                                <h4><a href="mailto:info@bigequipmentsindia.com" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL'];  ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91-83338 93338</a></h4> 
				<!-- end add by DEI IT Team -->
			  </div>
			</div>
			  ...
			  <!-- start added by DEI IT Team -->
				...
				<h4><a href="#"style="color:#ea2e2e;">Contact Parminder Singh</a> +91. 9725289394</h4>-->
                                <h2>Urgent Requirement at Gurgaon, Haryana : 80 Ton Mobile Crane</h2>
                                <h4><a href="mailto:info@bigequipmentsindia.com" style="color:#ea2e2e;">Contact us</a>&nbsp;at <a href="<?php echo Yii::$app->params['SITE_URL'];  ?>contact" style="color:#ea2e2e;">http://bigequipmentsindia.com/contact</a> or <a href="tel:8333893338" style="color:#fff;">+91-83338 93338</a></h4>
            ...
            <div class="machine-anim">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation">
                        ...
                        <img src="images/aw.png" alt="">
                        <div class="hsbbutton_wrapper">
                            <div><a href="products?product_type=hire&category=1">HIRE</a></div>
                            <div><a data-toggle="modal" data-target="#cranes">Supply</a></div>
                            <div><a href="products?product_type=sale&category=1">Buy</a></div>
                        </div>
                    </li>
                    <li role="presentation">
                        <a style="cursor: default;">
                        ...
                        <img src="images/awr.png" alt="">
                        <div class="hsbbutton_wrapper">
                            <div><a href="products?product_type=hire&category=5">HIRE</a></div>
                            <div><a data-toggle="modal" data-target="#rigs">Supply</a></div>
                            <div><a href="products?product_type=sale&category=5">Buy</a></div>
                        </div>
                    </li>
                    <li role="presentation">
                        <a style="cursor: default;">
                        ...
                        <img src="images/aw.png" alt="">
                        <div class="hsbbutton_wrapper">
                            <div><a href="products?product_type=hire&category=3">HIRE</a></div>
                            <div><a data-toggle="modal" data-target="#excavators">Supply</a></div>
                            <div><a href="products?product_type=sale&category=3">Buy</a></div>
                        </div>
                    </li>
                    <li role="presentation">
                        <a style="cursor: default;">
                        ...
                        <img src="images/awrr.png" alt="">
                        <div class="hsbbutton_wrapper">
                            <div><a href="products?product_type=hire&category=2">HIRE</a></div>
                            <div><a data-toggle="modal" data-target="#dumpers">Supply</a></div>
                            <div><a href="products?product_type=sale&category=2">Buy</a></div>
                        </div>
                    </li>
                    <li role="presentation">
                        <a style="cursor: default;">
                        ...
                        <img src="images/aw.png" alt="">
                        <div class="hsbbutton_wrapper">
                            <div><a href="products?product_type=hire&category=4">HIRE</a></div>
                            <div><a data-toggle="modal" data-target="#generators">Supply</a></div>
                            <div><a href="products?product_type=sale&category=4">Buy</a></div>
                        </div>
                    </li>
                </ul>
...
<div class="container">
    ...
    <center>
        ...
        if (Yii::$app->user->isGuest)
            echo '<a href="login" class="btn btn-default postyourad">POST YOUR ADVT</a>';
        else
            echo '<a href="#" class="btn btn-default postyourad" data-toggle="modal" data-target="#postad_modal">POST YOUR ADVT</a>';
        ?>	
    </center>                
...
// Calculate ratio of desired maximum sizes and original sizes.
    ...
    ?>
      ...
      <div class="item <?php if($i==0) echo "active";?>" >
        ...
        <?php } else if($ad->ad_type == 2){ 
            
            $video = str_replace("watch?v=", 'v/',$ad_image );
            ?>
          <center>
            <embed width="1000" height="360" src="<?php echo $video; ?>">
          </center>
        <?php } ?>
    </div>
    <?php $i++; endforeach; ?>
    ...
    ?>
      ...
      <div class="col-md-6">
				...
				<img src="<?php echo $array_hire_services[$h_index]['image_url']; ?>" class="img-responsive" />
                                ...
                                <div class="sevicebox_content" style="font-weight: bold;">
			   <h4><?php echo @$array_hire_services[$h_index]['category_name'];?></h4>
				...
				<div class="col-sm-4"><p>Year Of Manufacture</p><?php if($array_hire_services[$h_index]['manufacture_year']){ echo @$array_hire_services[$h_index]['manufacture_year']; } else { echo "Not Available";}?></div>
				<div class="clearfix"></div>
				<div class="hr"></div>
				<div class="footer">
  	  ...
  	  <div class="col-md-6">
			...
			<div class="sevicebox_content" style="font-weight: bold;">
			   <h4><?php echo @$array_sale_services[$s_index]['category_name'];?></h4>
				...
				<div class="col-sm-4"><p>Year of Manufacture</p><?php if($array_sale_services[$s_index]['manufacture_year']){ echo @$array_sale_services[$s_index]['manufacture_year']; } else { echo "Not Available"; } ?></div>
				<div class="clearfix"></div>
				<div class="hr"></div>
				<div class="footer">
					<div class="col-md-4 col-sm-4">
      ...
      <div class="modal-body">
        <div class="redoptions">
            <ul class="">
                ...
                <li><a href="addproduct?product_type=both&category=1">
      ...
      <div class="modal-body">
        <div class="redoptions">
            <ul class="">
                ...
                <li><a href="addproduct?product_type=both&category=5">
                        <img src="images/both.png" alt="">
                        <span>Both</span>
                </a></li>
      ...
      <div class="modal-body">
        <div class="redoptions">
            <ul class="">
                ...
                <li><a href="addproduct?product_type=both&category=3">
                        <img src="images/both.png" alt="">
                        <span>Both</span>
                </a></li>
      ...
      <div class="modal-body">
        <div class="redoptions">
            <ul class="">
                ...
                <li><a href="addproduct?product_type=both&category=2">
                        <img src="images/both.png" alt="">
                        <span>Both</span>
                </a></li>
      ...
      <div class="modal-body">
        <div class="redoptions">
            <ul class="">
                ...
                <li><a href="addproduct?product_type=both&category=4">
                        <img src="images/both.png" alt="">
                        <span>Both</span>
                </a></li>
            ...
            <div class="modal-body">
                ...
                <form action="facebookad" method="post" enctype="multipart/form-data" id="adform">
                    ...
                    <div class="modal-post">
                        ...
                        <div class="row video_ad">

                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Youtube video URL" name="video_link[]" id="video_link1" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Youtube video URL" name="video_link[]" id="video_link2">
                                </div>
                            </div>

                        </div>
                        <div class="row image_ad">
