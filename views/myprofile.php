                                ...
                                <tr>
                                    ...
                                    <?php } else { ?>
                                        <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp;
                                            ...
                                            <?php if($value['payment_type'] == 3 && $value['amount_paid']<$value['amount_actual']){ ?>
                                            <a href="javascript:void(0);" onclick="document.getElementById('paynow<?php echo "hire".$value['payment_id']; ?>').submit();" title="PAY NOW"><i class="fa fa-lg fa-credit-card" style="color:red;"></i></a>
                                            <form method="post" action="paynow" id="paynow<?php echo "hire".$value['payment_id']; ?>">
                                                <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                        ...
                        <table id="supplier_table" class="display datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!--<td><?php echo $value['current_location']; ?></td>-->
                                    <td><?php echo number_format($value['amount_actual']); ?></td>
                                    <td><?php echo number_format($value['amount_paid']); ?></td>
                                    <td><?php echo number_format($value['amount_actual']-$value['amount_paid']); ?></td>
                                    ...
                                    <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp;
                                        ...
                                        <a href="javascript:void(0);" onclick="document.getElementById('paynow<?php echo "supp".$value['payment_id']; ?>').submit();" title="PAY NOW"><i class="fa fa-lg fa-credit-card" style="color:red;"></i></a>
                                        <form method="post" action="paynow" id="paynow<?php echo "supp".$value['payment_id']; ?>">
                                            <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                                            <input type="hidden" id="payment_id" name="payment_id" value="<?php echo $value['payment_id'];?>">
                                        </form> 
                                        <?php }?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp;
                                        <a href="javascript:void(0);" onclick="deleteOrder(<?php echo $value['order_id']; ?>);"><i class="fa fa-lg fa-trash" style="color:red;"></i></a>&nbsp; 
                                        <?php if($value['payment_type'] == 3 && $value['amount_paid']<$value['amount_actual']){ ?>
                                        <a href="javascript:void(0);" onclick="document.getElementById('paynow<?php echo "buy".$value['payment_id']; ?>').submit();" title="PAY NOW"><i class="fa fa-lg fa-credit-card" style="color:red;"></i></a>
                                        <form method="post" action="paynow" id="paynow<?php echo "buy".$value['payment_id']; ?>">
                                            <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                                            <input type="hidden" id="payment_id" name="payment_id" value="<?php echo $value['payment_id'];?>">
                                        </form> 
                                        <?php }?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp; 
                                        <a href="javascript:void(0);" onclick="deleteProduct(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-trash" style="color:red;"></i></a> &nbsp;
                                        <?php if($value['payment_type'] == 1 && $value['amount_paid']<$value['amount_actual']){ ?>
                                        <a href="javascript:void(0);" onclick="document.getElementById('paynow<?php echo "sale".$value['payment_id']; ?>').submit();" title="PAY NOW"><i class="fa fa-lg fa-credit-card" style="color:red;"></i></a>
                                        <form method="post" action="paynow" id="paynow<?php echo "sale".$value['payment_id']; ?>">
                                            <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                                            <input type="hidden" id="payment_id" name="payment_id" value="<?php echo $value['payment_id'];?>">
                                        </form> 
                                        <?php }?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript:void(0);" onclick="getProductdata(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-eye" style="color:red;"></i></a> &nbsp;
                                        <a href="javascript:void(0);" onclick="deleteProduct(<?php echo $value['product_id']; ?>);"><i class="fa fa-lg fa-trash" style="color:red;"></i></a> &nbsp;
                                        <?php if($value['payment_type'] == 1 && $value['amount_paid']<$value['amount_actual']){ ?>
                                        <a href="javascript:void(0);" onclick="document.getElementById('paynow<?php echo "both".$value['payment_id']; ?>').submit();" title="PAY NOW"><i class="fa fa-lg fa-credit-card" style="color:red;"></i></a>
                                        <form method="post" action="paynow" id="paynow<?php echo "both".$value['payment_id']; ?>">
                                            <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                                            <input type="hidden" id="payment_id" name="payment_id" value="<?php echo $value['payment_id'];?>">
                    ...
                    <div role="tabpanel" class="tab-pane" id="ads">
                        ...
                        <table id="sale_table" class="display datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?php if($value['ad_type'] == 1){ ?>
                                            <a href="<?= $value['ad_image_url'] ?>"><img src="<?= $value['ad_image_url'] ?>" class="img-responsive"></a>
                                        <?php } else if($value['ad_type'] == 2){ ?>
                                            <?php $video_link = str_replace("watch?v=",'v/', $value['ad_image_url']);?>
                                            <div>
                                                <embed  style="max-width: 250px;" src="<?php echo $video_link; ?>" allowscriptaccess="always" allowfullscreen="true"></embed>
                                            </div>
                                        <?php } ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" onclick="document.getElementById('paynow<?php echo "advt".$value['payment_id']; ?>').submit();" title="PAY NOW"><i class="fa fa-lg fa-credit-card" style="color:red;"></i></a>
                                        <form method="post" action="paynow" id="paynow<?php echo "advt".$value['payment_id']; ?>">
                                            <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken()?>" />
                                            <input type="hidden" id="payment_id" name="payment_id" value="<?php echo $value['payment_id'];?>">
                                        </form> 
                                        <?php }?>
